...
public class HexedGenerator implements Cons<Tiles>{
    ...
    // v
    Block[][] floors = {
        {Blocks.sand, Blocks.darksandTaintedWater, Blocks.darksand, Blocks.sand, Blocks.hotrock, Blocks.sand},
        {Blocks.darksandWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.sand, Blocks.darksandTaintedWater},
        {Blocks.darksandWater, Blocks.hotrock, Blocks.darksand, Blocks.sand, Blocks.darksandTaintedWater, Blocks.sand},
        {Blocks.darksandTaintedWater, Blocks.darksandTaintedWater, Blocks.darksand, Blocks.darksand, Blocks.darksand, Blocks.darksand},
        {Blocks.darksand, Blocks.darksand, Blocks.hotrock, Blocks.darksandTaintedWater, Blocks.darksandTaintedWater, Blocks.sand}
    };
